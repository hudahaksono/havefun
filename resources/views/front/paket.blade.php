    ...
    <div id="product_detail" class="container">
        <div class="row">
            ...
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <p>
                    <a href="cart.html" class="btn btn-primary py-3 px-5"><i class="fa-solid fa-cart-shopping"></i> Add To Cart</a>
                    <a href="cart.html" class="btn btn-primary py-3 px-5"><i class="fa-solid fa-dollar-sign"></i> Checkout</a>
                </p>
            </div>
        </div>
    </div>
