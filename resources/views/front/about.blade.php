    ...
    <div class="one-half ftco-animate">
        <div class="overlap">
            <div class="heading-section ftco-animate ">
                ...
                <h2 class="mb-4">Cerita Savana</h2>
            </div>
            <div>
                <p>-- Tuliskan Sejarah Pembuatan Savana --</p>
            </div>
        </div>
    </div>
</section>
...
<section class="ftco-counter ftco-bg-dark img" id="section-counter" style="background-image: url(images/savana/savana1.jpg);" data-stellar-background-ratio="0.5">
