...
<section class="ftco-section img" id="banner" style="background:black" data-stellar-background-ratio="0.5">
        ...
        <div class="container">
            <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                <div class="col-md-8 col-sm-12 text-center ftco-animate">
                    ...
                    <p><a href="#" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a><a href="#start" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Product</a></p>
                </div>
            </div>
        </div>
    </div>
...
<section id="start" class="ftco-intro">
        ...
        <div class="row d-flex no-gutters">
            <div class="col-lg align-self-sm-end">
                <div class="testimony overlay">
                    <blockquote>
                        <p>&ldquo;Sungguh pelayanan yang luarbiasa, semua dekorasi yang disajikan sangan rapih dan detail seperti pada produk yang tertera pada gambar.&rdquo;</p>
                    </blockquote>
                    <div class="author d-flex mt-4">
                        <div class="image mr-3 align-self-center">
                            <img src="images/web/user-men.png" alt="">
                        </div>
                        <div class="name align-self-center">Nur Hudha Haksono <span class="position">Customer Paket Intimate</span></div>
                    </div>
                </div>
            </div>
            <div class="col-lg align-self-sm-end ftco-animate">
                <div class="testimony">
                    <blockquote>
                        <p>&ldquo;Responnya Cepat Adminnya Ramah dan Pelayanannya Bagus &rdquo;</p>
                    </blockquote>
                    <div class="author d-flex mt-4">
                        <div class="image mr-3 align-self-center">
                            <img src="images/web/user-men.png" alt="">
                        </div>
                        <div class="name align-self-center">Dini Restian <span class="position">Customer Paket Wedding Outdoor</span></div>
                    </div>
                </div>
            </div>
            <div class="col-lg align-self-sm-end">
            ...
            <div class="col-lg align-self-sm-end ftco-animate">
                <div class="testimony">
                    ...
                    <div class="author d-flex mt-4">
                        <div class="image mr-3 align-self-center">
                            <img src="images/web/user-women.png" alt="">
                        </div>
                        <div class="name align-self-center">Louise Kelly <span class="position">Illustrator Designer</span></div>
                    </div>
                </div>
