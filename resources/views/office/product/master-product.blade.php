    ...
    <section class="section">
        <div id="list_data" class="row">
            <div class="col-12 col-sm-12 col-lg-12">
                <div class="card">
                    <h3 class="text-center mt-3 mb-3">Master Barang</h3>
	    ...
	    function list_data() {
	        $("#tbl_list_hdr").DataTable({
	            ...
	            columns: [
	                ...
	                { data: "satuan", name: "satuan", visible: false }, // 3
	                { data: "id_kategori", name: "id_kategori", visible: false }, // 4
	                { data: "nama_kategori", name: "nama_kategori", visible: true }, // 5
	                { data: "id_ukuran", name: "id_ukuran", visible: false }, // 6
	                { data: "ukuran", name: "ukuran", visible: false }, // 7                         
	                { data: "file_name", name: "file_name", visible: true }, // 8
	                { data: "keterangan", name: "keterangan", visible: true }, // 9
	                { data: "action", name: "action", visible: true }, // 10
	            ],
