    ...
    <section class="section">
        <div id="list_data" class="row">
            <div class="col-12 col-sm-12 col-lg-12">
                <div class="card">
                    <h3 class="text-center mt-3 mb-3">Daftar Invoice Outstanding</h3>
    ...
    $(document).ready(function() {
        ...
        function list_data() {
            $("#tbl_list_hdr").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{route('api.payment.list.invoice.os')}}",
                    type: "GET",
                },
                columns: [{
                        data: "id",
        ...
        $('body').on('click', '#cetak', function(e) {
            ...
            window.open("/invoice-outstanding/generate?id=" + id, "_blank");
        });
    });
</script>