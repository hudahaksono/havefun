                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="/master-user">Master User</a></li>
                                <li><a class="nav-link" href="/master-akses">Master Access</a></li>
                                <li><a class="nav-link" href="/master-kategori">Master Categori</a></li>
                                <li><a class="nav-link" href="/master-product">Master Product</a></li>
                            </ul>
                        </li>
