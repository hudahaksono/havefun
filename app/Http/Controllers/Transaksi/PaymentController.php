...
class PaymentController extends Controller
{
	public function index()
    {
        ...
        $user_baru = DB::table('mst_users')
                        ...
                        ->where('created_at','>=',$date)
                        ->get();
        return view('office.transaksi.tr-payment', compact('order_baru','pembayaran','user_baru'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if(floatval($data->actual_payment) == 0 && $os_payment > 0){
                $order_save->flag_dp = 1;
            }else{
                $order_save->flag_dp = 0;
            }
